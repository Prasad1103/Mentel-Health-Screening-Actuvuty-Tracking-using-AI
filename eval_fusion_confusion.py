...
print(f'
Text inference complete. Shape: {text_probs.shape}')
...
(Text only, audio/face = uniform)', fontsize=14)
plt.tight_layout()
...
plt.xlabel('Predicted Label', fontsize=12)
plt.ylabel('True Label', fontsize=12)
plt.title('Fusion Model Normalized Confusion Matrix
(Text only, audio/face = uniform)', fontsize=14)
plt.tight_layout()
...
plt.ylabel('True Label', fontsize=12)
plt.title('Fusion Model Confusion Matrix
(All 3 modalities agree)', fontsize=14)
plt.tight_layout()
